...
def utils_base64secret_decode(base64_key: str, required_key_len: int, out_key: typing.Optional[int] = None) -> bool: ...
...
def utils_security_valid(type: UtilsSecurityType, wifi_caps: DeviceWifiCapabilities, have_ap: bool, adhoc: bool, ap_flags: NM80211ApFlags, ap_wpa: NM80211ApSecurityFlags, ap_rsn: NM80211ApSecurityFlags) -> bool: ...
...
class Client(GObject.Object, Gio.AsyncInitable, Gio.Initable):
    ...
    def get_logging(self, level: typing.Optional[str] = None, domains: typing.Optional[str] = None) -> bool: ...
...
class Connection(GObject.GInterface):
    ...
    def diff(self, b: Connection, flags: SettingCompareFlags, out_settings: dict[str, dict[None, None]]) -> bool: ...
    def dump(self) -> None: ...
    ...
    def need_secrets(self) -> typing.Tuple[str, list[str]]: ...
...
class Setting(GObject.Object):
    ...
    def option_get_all_names(self) -> list[str]: ...
...
class SettingIP4Config(SettingIPConfig):
    ...
    def __init__(self, dhcp_client_id: str = ...,
                 ...
                 route_metric: int = ...,
                 route_table: int = ...,
                 routes: typing.Sequence[IPRoute] = ...) -> None: ...
...
class SettingWireGuard(Setting):
    ...
    def get_peer_by_public_key(self, public_key: str) -> typing.Tuple[WireGuardPeer, int]: ...
...
class SettingWireless(Setting):
    ...
    def ap_security_compatible(self, s_wireless_sec: SettingWirelessSecurity, ap_flags: NM80211ApFlags, ap_wpa: NM80211ApSecurityFlags, ap_rsn: NM80211ApSecurityFlags, ap_mode: NM80211Mode) -> bool: ...
    def clear_mac_blacklist_items(self) -> None: ...
...
class VpnPluginInfo(GObject.Object, Gio.Initable):
    ...
    @classmethod
    def new_search_file(cls, name: typing.Optional[str] = None, service: typing.Optional[str] = None) -> VpnPluginInfo: ...
    @classmethod
...
class WireGuardPeer(GObject.GBoxed):
    ...
    def get_allowed_ip(self, idx: int, out_is_valid: typing.Optional[bool] = None) -> str: ...
...
class NM80211ApFlags(GObject.GFlags):
    NONE = 0
    PRIVACY = 1
    WPS = 2
    WPS_PBC = 4
...
class NM80211ApSecurityFlags(GObject.GFlags):
    GROUP_CCMP = 128
    GROUP_TKIP = 64
    GROUP_WEP104 = 32
    GROUP_WEP40 = 16
...
class NM80211Mode(GObject.GEnum):
    ADHOC = 1
    AP = 3
    INFRA = 2
    MESH = 4
